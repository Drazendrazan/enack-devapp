...
Config = {
	...
	Timings = { -- Time it takes to do things
		["Cracking"] = math.random(20000, 25000),
		["Washing"] = math.random(20000, 25000),
		["Panning"] = math.random(20000, 25000),
	...
	Locations =  {
		['MineStore'] = {
			{ name = "Mine", coords = vector4(-593.3, 2092.59, 131.79, 48.8), sprite = 527, col = 81, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },		-- The location where you enter the mine
			{ name = "Quarry", coords = vector4(2958.93, 2754.18, 43.71, 189.6), sprite = 527, col = 81, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
--			{ name = "Foundary Store", coords = vector4(1074.89, -1988.19, 30.89, 235.07), sprite = 436, col = 1, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
		...
		['Smelter'] = {	 -- The location of the smelter
			{ name = "Smeltery", coords = vector3(1112.29, -2009.9, 31.46), sprite = 436, col = 1, blipTrue = true },
		},
		["Washing"] = {
			{ name = "Stone Washing", coords = vector3(1836.36, 409.07, 160.97), sprite = 467, col = 3, disp = 6, blipTrue = true }, -- Mountains
			{ name = "Stone Washing", coords = vector3(2497.55, 6126.77, 162.49), sprite = 467, col = 3, disp = 6, blipTrue = true }, -- Gordo
			{ name = "Stone Washing", coords = vector3(-437.17, 2941.1, 13.95), sprite = 467, col = 3, disp = 6, blipTrue = true }, -- Stream
			...
			--{ name = "Stone Washing", coords = vector3(911.58, 4384.55, 30.94), sprite = 467, col = 3, disp = 6, blipTrue = true }, -- Alamo Sea
		...
		["Panning"] = {
			{ name = "Gold Panning", coords = vector3(-1655.72, 2073.16, 87.37), sprite = 467, col = 5, disp = 6, blipTrue = true }, -- Vineyard
			{ name = "Gold Panning", coords = vector3(-1549.46, 1442.68, 116.9), sprite = 467, col = 5, disp = 6, blipTrue = true }, -- Tongva
			{ name = "Gold Panning", coords = vector3(-856.11, 4440.88, 15.55), sprite = 467, col = 5, disp = 6, blipTrue = true }, -- Wilderness
		...
		['Cracking'] = {
			{ name = "Stone Cracking", coords = vector4(1107.43, -1993.07, 30.96, 140.81), sprite = 566, col = 81, blipTrue = false, prop = `gr_prop_gr_speeddrill_01c` }, 
			{ name = "Stone Cracking", coords = vector4(1112.25, -1998.07, 30.99, 49.4), sprite = 566, col = 81, blipTrue = false, prop = `gr_prop_gr_speeddrill_01c` }, 
		},
		['OreBuyer'] = { -- Ore buyer has been removed in place of the pawn shop
			{ name = "Ore Buyer", coords = vector4(1100.24, -1989.67, 1.08, 74.69), sprite = 568, col = 81, blipTrue = false, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		},
		['JewelCut'] = { -- Drills at Postal 35 Docks - NO BLIPS
			{ name = "Jewel Cutting", coords = vector4(57.88, -2685.16, 6.01, 0.2), sprite = 566, col = 81, blipTrue = false, prop = `gr_prop_gr_speeddrill_01c` },
			{ name = "Jewel Cutting", coords = vector4(55.65, -2685.19, 6.01, 0.2), sprite = 566, col = 81, blipTrue = false, prop = `gr_prop_gr_speeddrill_01c` },
		},
		['JewelBuyer'] = { -- Inside Vangelicos Management Office
			{ name = "Jewel Buyer", coords = vector4(-630.73, -228.48, 38.06, 235.7), sprite = 527, col = 617, blipTrue = false, model = `S_M_M_HighSec_03`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		},
	},
...
------------------------------------------------------------
	SellItems = { -- Selling Prices
		...
		['ruby_ring'] = 10,
		['sapphire_ring'] = 10,
		['diamond_ring_silver'] = 10,
		['emerald_ring_silver'] = 10,
		['ruby_ring_silver'] = 10,
		['sapphire_ring_silver'] = 10,

		['diamond_necklace'] = 10,
		['emerald_necklace'] = 10,
		['ruby_necklace'] = 10,
		['sapphire_necklace'] = 10,
		['diamond_necklace_silver'] = 10,
		['emerald_necklace_silver'] = 10,
		['ruby_necklace_silver'] = 10,
		['sapphire_necklace_silver'] = 10,

		['diamond_earring'] = 10,
		['emerald_earring'] = 10,
		['ruby_earring'] = 10,
		['sapphire_earring'] = 10,
		['diamond_earring_silver'] = 10,
		['emerald_earring_silver'] = 10,
		['ruby_earring_silver'] = 10,
		['sapphire_earring_silver'] = 10,
...
--Mining Store Items
	Items = {
		...
		items = {
			{ name = "water_bottle", price = 100, amount = 50, info = {}, type = "item", slot = 1, },
			{ name = "sandwich", price = 100, amount = 50, info = {}, type = "item", slot = 2, },
			{ name = "bandage", price = 100, amount = 50, info = {}, type = "item", slot = 3, },
			{ name = "drillbit", price = 100, amount = 50, info = {}, type = "item", slot = 4, },
...
Crafting = {
	SmeltMenu = {
		...
		{ ["goldingot"] = { ["goldore"] = 15 } },
		{ ["silveringot"] = { ["silverore"] = 10 } },
		{ ["iron"] = { ["ironore"] = 2 }, ['amount'] = 4 },
		{ ["steel"] = { ["ironore"] = 2, ["carbon"] = 2 }, ['amount'] = 2 },
		{ ["aluminum"] = { ["can"] = 2, }, ['amount'] = 4 },
	...
	GemCut = {
		{ ["emerald"] = { ["uncut_emerald"] = 15, }, },
		{ ["diamond"] = { ["uncut_diamond"] = 15}, },
		{ ["ruby"] = { ["uncut_ruby"] = 15 }, },
		{ ["sapphire"] = { ["uncut_sapphire"] = 15 }, },
	},
	RingCut = {
...
K4MB1 = {
	...
	['Cracking'] = { -- The location of the smelter
		{ name = "Stone Cracking", coords = vector4(2914.9, 2650.78, 43.08, 231.77), sprite = 566, col = 81, blipTrue = false, prop = `gr_prop_gr_speeddrill_01c` }, -- Foundary
		{ name = "Stone Cracking", coords = vector4(2914.61, 2649.06, 43.19, 272.74), sprite = 566, col = 81, blipTrue = false, prop = `gr_prop_gr_speeddrill_01c` }, -- Foundary
	},
